...
import net.yukitteru.easywms.dao.ProductDao;
import net.yukitteru.easywms.dto.ProductDto;
import net.yukitteru.easywms.entity.Product;
import net.yukitteru.easywms.exception.UploadProductException;
import net.yukitteru.easywms.util.converter.ProductDtoToProductConverter;
...
public class UploadProductService {
        ...
        return productDao.findByArticleIn(productArticles)
                ...
                .flatMap(product -> {
                    ...
                    if (product.getQuantity() == null) {
                        return Flux.error(new UploadProductException(
    ...
    private void addProductToIndex(String fileName, int rowCounter, Map<Product, BigInteger> productIndex, Row currentRow) {
        ...
        if (ObjectUtils.isEmpty(article)) formBulkImportException(fileName, rowCounter, NAME_COLUMN);
        ...
        int sizeInteger = Integer.parseInt(getCell(currentRow, 3));
        if (sizeInteger == 0) {
